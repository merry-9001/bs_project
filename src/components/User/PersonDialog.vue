...
export default {
  ...
  methods: {
    ...
    handleToUpload(ev) {
      ...
      //   console.log('asddas');
      this.axios
        .post("/personCustom_api/bs_picLoad.php", param, config)
        .then(res => {
          //   console.log(res);
    ...
    onSubmit(data) {
      ...
      params.append("project_id", this.formData.project_name);
      ...
      if (f === "add") {
        this.axios.post("/personCustom_api/PersonTp5/public/index/bs/shop_add", params).then(res => {
          console.log(res);
          // var stauts = res.data.stauts;
          // console.log(msg);
          // var that = this;
        ...
        //   personEdit.php
        //   console.log(this.formData.project_id);
          this.axios.post("/personCustom_api/PersonTp5/public/index/bs/shop_edit", params).then(res => {
          console.log(res);
